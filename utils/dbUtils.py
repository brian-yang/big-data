...
> Input: STRING location, STRING code, TEXT latitude, TEXT longitude 
'''
def addBill(count, location, code, lat, lng):
    q = "INSERT INTO billionaires(count, location, code, lat, lng) VALUES(?,?,?)"
    c.execute(q, (count, location, code, lat, lng))
    conn.commit()
